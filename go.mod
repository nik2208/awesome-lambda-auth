module github.com/nik2208/awesome-lambda-auth
...
require (
	...
	github.com/nik2208/awesome-go-auth v0.8.0
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cognitoidentityprovider v1.68.0 // indirect
